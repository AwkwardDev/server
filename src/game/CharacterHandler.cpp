...
void WorldSession::HandlePlayerLogin(LoginQueryHolder *holder)
{
    ...
    /* Initialise a new instance of the motion generator?
     * Evilfairy: I think this is for random movement like fears and such?
    ...
    {
        /* Could not load character from database, cancel login */
        ...
        /* Finally return, we have nothing more to do here */
        return;
    }
    ...
    /* Evilfairy: Wtf? I'm fairly sure this is wrong... I'll look into it some other time
     * TODO: Research what is meant to be sent here */
    ...
    /* Add the player to the object accessor */
    ...
    if (pCurrChar->m_deathState != ALIVE)
    {
        ...
        if(pCurrChar->getRace() == RACE_NIGHTELF)
            pCurrChar->CastSpell(pCurrChar, 20584, true); // wisp spell
