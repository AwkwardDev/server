...
inline void DynamicObjectUpdater::VisitHelper(Unit* target)
{
...
template<>
inline void DynamicObjectUpdater::Visit(CreatureMapType  &m)
{
...
template<>
inline void DynamicObjectUpdater::Visit(PlayerMapType  &m)
{
